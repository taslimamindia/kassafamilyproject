    ...
    return (
        <div className="card h-100 border-0 shadow-sm rounded-4 transaction-card">
            <div className="card-body p-4 d-flex flex-column">
                ...
                <div className="border-top pt-3 d-flex justify-content-end align-items-center gap-2 mt-auto">
                    ...
                    {canSubmit && (
                        <button className="btn btn-sm btn-success rounded-pill px-3" onClick={onSubmit} title="Soumettre">
                    ...
                    {hasProofUrl && (
                         <button className="btn btn-sm btn-info text-white rounded-pill px-3" onClick={() => setShowProof(true)}>
